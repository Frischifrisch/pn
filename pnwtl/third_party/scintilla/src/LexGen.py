...
def RegenerateAll():
    ...
    lexFilePaths = glob.glob(f"{root}scintilla/lexers/Lex*.cxx")
    ...
    if os.path.exists(f"{root}scite"):
        propFilePaths = glob.glob(f"{root}scite/src/*.properties")
    ...
    Regenerate(f"{root}scintilla/src/Catalogue.cxx", "//", NATIVE, lexerModules)
    Regenerate(f"{root}scintilla/win32/scintilla.mak", "#", NATIVE, lexFiles)
    Regenerate(f"{root}scintilla/win32/scintilla_vc6.mak", "#", NATIVE, lexFiles)
    if os.path.exists(f"{root}scite"):
        Regenerate(f"{root}scite/win32/makefile", "#", NATIVE, propFiles)
        Regenerate(f"{root}scite/win32/scite.mak", "#", NATIVE, propFiles)
        Regenerate(f"{root}scite/src/SciTEProps.cxx", "//", NATIVE, lexerProperties)
        Regenerate(f"{root}scite/doc/SciTEDoc.html", "<!--", NATIVE, propertiesHTML)
        Generate(
            f"{root}scite/boundscheck/vcproj.gen",
            f"{root}scite/boundscheck/SciTE.vcproj",
            "#",
            NATIVE,
            lexFiles,
        )
